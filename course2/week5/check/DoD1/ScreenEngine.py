...
class ProgressBar(ScreenHandle):
    ...
    def draw(self, canvas):
        ...
        pygame.draw.rect(self, colors[
                         "red"], (50, 30, 200 * max(self.engine.hero.hp,0) / self.engine.hero.max_hp, 30))
        ...
        self.blit(font.render(f'{max(self.engine.hero.hp,0)}/{self.engine.hero.max_hp}', True, colors["black"]),
                  (60, 30))
